...
class BacktrackingTests(unittest.TestCase):
  ...
  def test_bt_simple_6(self):
    ...
    # Trial 1 = 151.700
    # Trial 2 = 171.7722053779944
    print('Backtracking average time simple 6:', timeit.timeit(setup=SETUP,stmt='backtracking(Key.C, True, 6, [])', number=1) / 1)

  def test_bt_two_qualities_4(self):
    self.assertEqual(len(backtracking(Key.C, True, 4, [ChordQuality.MAJ7, ChordQuality.HALF_DIM])), 1227)
    # Average time (10 trials) = 
    print('Backtracking average time two qualities 4:', (timeit.timeit(setup=SETUP,stmt='backtracking(Key.C, True, 4, [ChordQuality.MAJ7, ChordQuality.HALF_DIM])', number=10) / 10))

  def test_bt_two_qualities_6(self):
    self.assertEqual(len(backtracking(Key.C, True, 6, [ChordQuality.MAJ7, ChordQuality.HALF_DIM])), 1227)
    # Average time (10 trials) = 
  ...
  def test_fc_two_qualities_4(self):
    self.assertEqual(len(backtrackingFC(Key.C, True, 4, [ChordQuality.MAJ7, ChordQuality.HALF_DIM])), 1227)
    # Average time (10 trials) = 
  ...
  def test_nogood_two_qualities_4(self):
    self.assertEqual(len(backtrackingConflictSet(Key.C, True, 4, [ChordQuality.MAJ7, ChordQuality.HALF_DIM])), 1227)
    # Average time (10 trials) = 
  ...
  def test_gac_two_qualities_4(self):
    self.assertEqual(len(backtrackingGAC(Key.C, True, 4, [ChordQuality.MAJ7, ChordQuality.HALF_DIM])), 1227)
    # Average time (10 trials) = 
  ...
  def test_gac_pre_two_qualities_4(self):
    self.assertEqual(len(backtrackingGACPre(Key.C, True, 4, [ChordQuality.MAJ7, ChordQuality.HALF_DIM])), 1227)
    # Average time (10 trials) = 
